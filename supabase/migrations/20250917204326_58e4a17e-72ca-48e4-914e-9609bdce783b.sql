-- Fix CTE reference in get_dashboard_kpis_with_virtual_tag when filtering by virtual tag
CREATE OR REPLACE FUNCTION public.get_dashboard_kpis_with_virtual_tag(
