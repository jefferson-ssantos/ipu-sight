...
import { BarChart3, Database, Tags } from 'lucide-react';
import { useDashboardData } from '@/hooks/useDashboardData';
import { AssetDetailsWithTags } from '@/components/consumption/AssetDetailsWithTags';
    ...
    <AppLayout>
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            <h1 className="text-3xl font-bold">Consumo por Assets</h1>
            <p className="text-muted-foreground">
              Análise detalhada do consumo de IPU por assets com sistema de tags customizadas
            </p>
          </div>
